...
The "Sample Data" folder includes the electricity demand of a specific district in Enschede City, the Netherlands alongside the climatic data of the case study to calculate the maximum power generated by the renewable sources. By using the given data, you can reproduce    the given result for the week 50 (The observed peak) of the demand profile.
